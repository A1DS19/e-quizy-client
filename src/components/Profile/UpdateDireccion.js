...
import { updateDireccion, fetchAddresses } from '../../actions';
            ...
            <div className='col-md-12 ml-auto mr-auto'>
              ...
              <Formik
                ...
                onSubmit={(values, { setSubmitting, resetForm }) => {
                  setSubmitting(true);
                  this.props.updateDireccion(this.props.id, values, () => {
                    this.props.onClose();
                  });
                  setSubmitting(false);
                }}
...
export default compose(connect(mapStateToProps, { updateDireccion, fetchAddresses }))(
  UpdateDireccion
);
